class PufffishPink extends MovableObjects {
    path = [
    ...
    animate() {
        this.moveLeft();
        setInterval(() => {
            let i = this.currentImage % this.IMAGES_IDLE_RED.length; // modulos -> Makes a loop over the lenghth of the array 0 to 5 to 0 
            let path = this.IMAGES_IDLE_RED[i];
